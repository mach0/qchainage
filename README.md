...
- chainage only selected features or all features in a layer
- chainage from selectable start to endpoint or the whole feature (or any other combinations)
...
- create start and endpoint of a line
- do reverse chainage
