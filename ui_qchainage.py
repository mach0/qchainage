...
#
# Created: Mon Aug 18 22:24:20 2014
...
class Ui_QChainageDialog(object):
    def setupUi(self, QChainageDialog):
        ...
        QChainageDialog.resize(398, 240)
        ...
        self.gridLayout_2.addWidget(self.labelLayerName, 3, 0, 1, 2)
        self.layerNameLine = QtGui.QLineEdit(self.tab)
        self.layerNameLine.setObjectName(_fromUtf8("layerNameLine"))
        self.gridLayout_2.addWidget(self.layerNameLine, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.autoLabelCheckBox, 4, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.selectOnlyRadioBtn, 1, 1, 1, 1)
