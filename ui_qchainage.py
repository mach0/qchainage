...
class Ui_QChainageDialog(object):
    ...
    def retranslateUi(self, QChainageDialog):
        ...
        self.label_4.setText(_translate("QChainageDialog", "Decimal places", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("QChainageDialog", "Labeling", None))
